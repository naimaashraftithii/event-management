      ...
      <div className="max-w-4xl w-full grid gap-10 md:grid-cols-[1.2fr,1fr] items-center">
        ...
        <div className="bg-[#0b1020] border border-white/10 rounded-3xl shadow-xl shadow-black/40 px-6 py-7 md:px-8 md:py-9">
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 w-full inline-flex items-center justify-center gap-2 rounded-full bg-[#ff9f1a] px-5 py-2.5 text-sm font-semibold text-black hover:bg-[#ff7a00] transition shadow-md shadow-black/30 disabled:opacity-60 disabled:cursor-not-allowed"
          >
            <FcGoogle size={20} />
